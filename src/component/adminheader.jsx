...
//                         <li><Link to="/addproduct" className="hover:text-gray-200 transition">Add Product</Link></li>
//                         <li><Link to="/getproduct" className="hover:text-gray-200 transition">All Products </Link></li>
            ...
            {menuOpen && (
                <div className="md:hidden bg-[#36594E] px-6 pb-4">
                    <ul className="flex flex-col space-y-4 text-sm font-medium">
                        ...
                        <li><Link onClick={() => setMenuOpen(false)} to="/addproduct">Add Product</Link></li>
                        <li><Link onClick={() => setMenuOpen(false)} to="/getproduct">All Products</Link></li>
                    </ul>
                </div>
            )}
        </header>
